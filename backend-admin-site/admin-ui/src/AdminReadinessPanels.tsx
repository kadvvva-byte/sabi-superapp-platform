...
const rows = [
  {
    ...
    description: "РћР±С‰РёР№ СЌРєСЂР°РЅ РєРѕРЅС‚СЂРѕР»СЏ РєР°С‡РµСЃС‚РІР° Admin UI. Messenger, Taxi Рё Taxi Finance РЅРµ РёР·РјРµРЅСЏСЋС‚СЃСЏ."
  },
  {
    id: "owner",
...
export function AdminReadinessPanels(_props: AdminPanelProps = {}) {
  return (
    <section className="sabi-admin-program-screen" data-language="ru" data-ru-only="true">
      <header className="sabi-admin-program-header">
        ...
        <h1>Р“РѕС‚РѕРІРЅРѕСЃС‚СЊ Admin UI РїРѕ РїСЂРѕРіСЂР°РјРјР°Рј</h1>
        <p>РћР±С‰РёР№ СЌРєСЂР°РЅ РєРѕРЅС‚СЂРѕР»СЏ РєР°С‡РµСЃС‚РІР° Admin UI. Messenger, Taxi Рё Taxi Finance РЅРµ РёР·РјРµРЅСЏСЋС‚СЃСЏ.</p>
      </header>
...
export default AdminReadinessPanels;
