...
const rows = [
  {
    ...
    description: "Р­РєСЂР°РЅ РїРѕРєР°Р·С‹РІР°РµС‚ С‚РѕР»СЊРєРѕ РіРѕС‚РѕРІРЅРѕСЃС‚СЊ РїСЂРѕРІР°Р№РґРµСЂР° Рё Р±Р»РѕРєРёСЂРѕРІРєРё. Р РµР°Р»СЊРЅС‹Рµ provider calls, РєР»СЋС‡Рё, РїР»Р°С‚РµР¶Рё Рё payout РЅРµ РІС‹РїРѕР»РЅСЏСЋС‚СЃСЏ."
  },
  {
    id: "owner",
...
export function Airwallex174AAdminPanel(_props: AdminPanelProps = {}) {
  return (
    <section className="sabi-admin-program-screen" data-language="ru" data-ru-only="true">
      <header className="sabi-admin-program-header">
        ...
        <h1>РљРѕРЅС‚СЂРѕР»СЊ РіРѕС‚РѕРІРЅРѕСЃС‚Рё Airwallex</h1>
        <p>Р­РєСЂР°РЅ РїРѕРєР°Р·С‹РІР°РµС‚ С‚РѕР»СЊРєРѕ РіРѕС‚РѕРІРЅРѕСЃС‚СЊ РїСЂРѕРІР°Р№РґРµСЂР° Рё Р±Р»РѕРєРёСЂРѕРІРєРё. Р РµР°Р»СЊРЅС‹Рµ provider calls, РєР»СЋС‡Рё, РїР»Р°С‚РµР¶Рё Рё payout РЅРµ РІС‹РїРѕР»РЅСЏСЋС‚СЃСЏ.</p>
      </header>
...
export default Airwallex174AAdminPanel;
