...
const rows = [
  {
    ...
    description: "РљРѕРЅС‚СЂРѕР»СЊ СЃС‚Р°С‚СѓСЃР°, readiness, audit Рё Owner approval gates РґР»СЏ Airwallex Р±РµР· СЂРµР°Р»СЊРЅРѕРіРѕ Р·Р°РїСѓСЃРєР°."
  },
  {
    id: "owner",
...
export function AirwallexAdminControl100Panel(_props: AdminPanelProps = {}) {
  return (
    <section className="sabi-admin-program-screen" data-language="ru" data-ru-only="true">
      <header className="sabi-admin-program-header">
        ...
        <h1>Р¦РµРЅС‚СЂ РєРѕРЅС‚СЂРѕР»СЏ Airwallex</h1>
        <p>РљРѕРЅС‚СЂРѕР»СЊ СЃС‚Р°С‚СѓСЃР°, readiness, audit Рё Owner approval gates РґР»СЏ Airwallex Р±РµР· СЂРµР°Р»СЊРЅРѕРіРѕ Р·Р°РїСѓСЃРєР°.</p>
      </header>
...
export default AirwallexAdminControl100Panel;
