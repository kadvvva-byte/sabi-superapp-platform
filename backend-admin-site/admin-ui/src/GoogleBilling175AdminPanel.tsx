...
const rows = [
  {
    ...
    description: "РљРѕРЅС‚СЂРѕР»СЊ РіРѕС‚РѕРІРЅРѕСЃС‚Рё Google Billing. РђРєС‚РёРІР°С†РёСЏ, billing execution Рё provider calls Р·Р°Р±Р»РѕРєРёСЂРѕРІР°РЅС‹ РґРѕ РѕС‚РґРµР»СЊРЅРѕРіРѕ Owner approval."
  },
  {
    id: "owner",
...
export function GoogleBilling175AdminPanel(_props: AdminPanelProps = {}) {
  return (
    <section className="sabi-admin-program-screen" data-language="ru" data-ru-only="true">
      <header className="sabi-admin-program-header">
        ...
        <h1>Р“РѕС‚РѕРІРЅРѕСЃС‚СЊ Google Billing</h1>
        <p>РљРѕРЅС‚СЂРѕР»СЊ РіРѕС‚РѕРІРЅРѕСЃС‚Рё Google Billing. РђРєС‚РёРІР°С†РёСЏ, billing execution Рё provider calls Р·Р°Р±Р»РѕРєРёСЂРѕРІР°РЅС‹ РґРѕ РѕС‚РґРµР»СЊРЅРѕРіРѕ Owner approval.</p>
      </header>
...
export default GoogleBilling175AdminPanel;
