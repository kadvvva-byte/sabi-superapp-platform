...
const rows = [
  {
    ...
    description: "Р­РєСЂР°РЅ Stream РѕС‚РІРµС‡Р°РµС‚ Р·Р° РјРѕРґРµСЂР°С†РёСЋ, Р±РµР·РѕРїР°СЃРЅРѕСЃС‚СЊ РєРѕРЅС‚РµРЅС‚Р°, Р¶Р°Р»РѕР±С‹, evidence, СЃС‚Р°С‚СѓСЃС‹ РїСѓР±Р»РёРєР°С†РёРё Рё РѕС‚С‡С‘С‚С‹ РґР»СЏ Owner."
  },
  {
    id: "owner",
...
export function StreamAdminControl100Panel(_props: AdminPanelProps = {}) {
  return (
    <section className="sabi-admin-program-screen" data-language="ru" data-ru-only="true">
      <header className="sabi-admin-program-header">
        ...
        <h1>Р¦РµРЅС‚СЂ СѓРїСЂР°РІР»РµРЅРёСЏ Stream</h1>
        <p>Р­РєСЂР°РЅ Stream РѕС‚РІРµС‡Р°РµС‚ Р·Р° РјРѕРґРµСЂР°С†РёСЋ, Р±РµР·РѕРїР°СЃРЅРѕСЃС‚СЊ РєРѕРЅС‚РµРЅС‚Р°, Р¶Р°Р»РѕР±С‹, evidence, СЃС‚Р°С‚СѓСЃС‹ РїСѓР±Р»РёРєР°С†РёРё Рё РѕС‚С‡С‘С‚С‹ РґР»СЏ Owner.</p>
      </header>
...
export default StreamAdminControl100Panel;
