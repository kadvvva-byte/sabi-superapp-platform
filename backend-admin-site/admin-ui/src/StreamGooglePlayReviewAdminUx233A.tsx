...
const rows = [
  {
    ...
    description: "Р­РєСЂР°РЅ РіРѕС‚РѕРІРЅРѕСЃС‚Рё Stream Рє РїСЂРѕРІРµСЂРєРµ РјР°РіР°Р·РёРЅР°: UGC, РјРѕРґРµСЂР°С†РёСЏ, Р¶Р°Р»РѕР±С‹, privacy, audit evidence Рё Р±Р»РѕРєРёСЂРѕРІРєРё."
  },
  {
    id: "owner",
...
export function StreamGooglePlayReviewAdminUx233APanel(_props: AdminPanelProps = {}) {
  return (
    <section className="sabi-admin-program-screen" data-language="ru" data-ru-only="true">
      <header className="sabi-admin-program-header">
        ...
        <h1>РљРѕРЅС‚СЂРѕР»СЊ РїСЂРѕРІРµСЂРєРё Stream РґР»СЏ РјР°РіР°Р·РёРЅР°</h1>
        <p>Р­РєСЂР°РЅ РіРѕС‚РѕРІРЅРѕСЃС‚Рё Stream Рє РїСЂРѕРІРµСЂРєРµ РјР°РіР°Р·РёРЅР°: UGC, РјРѕРґРµСЂР°С†РёСЏ, Р¶Р°Р»РѕР±С‹, privacy, audit evidence Рё Р±Р»РѕРєРёСЂРѕРІРєРё.</p>
      </header>
...
export default StreamGooglePlayReviewAdminUx233APanel;
