...
const rows = [
  {
    ...
    description: "РљРѕРЅС‚СЂРѕР»СЊ runtime-РіРѕС‚РѕРІРЅРѕСЃС‚Рё Stream Р±РµР· provider calls, DB writes, РїСѓР±Р»РёРєР°С†РёРё Рё СЂРµР°Р»СЊРЅРѕРіРѕ Р·Р°РїСѓСЃРєР°."
  },
  {
    id: "owner",
...
export function StreamRuntimeFoundationAdminPanel(_props: AdminPanelProps = {}) {
  return (
    <section className="sabi-admin-program-screen" data-language="ru" data-ru-only="true">
      <header className="sabi-admin-program-header">
        ...
        <h1>Runtime-РѕСЃРЅРѕРІР° Stream</h1>
        <p>РљРѕРЅС‚СЂРѕР»СЊ runtime-РіРѕС‚РѕРІРЅРѕСЃС‚Рё Stream Р±РµР· provider calls, DB writes, РїСѓР±Р»РёРєР°С†РёРё Рё СЂРµР°Р»СЊРЅРѕРіРѕ Р·Р°РїСѓСЃРєР°.</p>
      </header>
...
export default StreamRuntimeFoundationAdminPanel;
