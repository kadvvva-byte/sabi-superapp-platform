export type Sms241AReadinessPercent = 0 | 100;

export type Sms241AFinalRunCommandShapeCandidate = Readonly<{
  ...
  exactFinalRunCommandCandidateText: 'I approve SMS-241A owner exact final run command shape candidate for Admin UI masked readiness build smoke planning only';
  ...
  readiness: Sms241AReadiness;
  safety: Sms241ASafety;
  nextStep: '241B_admin_readiness_panel_masked_status_build_smoke_owner_exact_final_run_command_shape_candidate_static_check_still_no_live_sms';
...
export type Sms241AReadiness = Readonly<{
  sms241AFinalRunCommandShapeCandidateReady: Sms241AReadinessPercent;
  sms240ZFinalPreExecutionSummaryReady: Sms241AReadinessPercent;
  sms240YFix1ShortPathStaticCheckReady: Sms241AReadinessPercent;
  sms240XAcceptanceGateReady: Sms241AReadinessPercent;
...
export type Sms241ASafety = Readonly<{
  noLiveSms: true;
