export type Sms241KReadiness = Readonly<{
...
export type Sms241KGate = Readonly<{
  acceptedNow: false;
  executableNow: false;
  noExecutionNow: true;
...
export type Sms241KSafety = Readonly<{
  noLiveSms: true;
...
export type Sms241KReport = Readonly<{
  version: string;
  marker: string;
  ...
  readiness: Sms241KReadiness;
  gate: Sms241KGate;
  safety: Sms241KSafety;
