export type Sms242CReadiness = Readonly<{
...
export type Sms242CSafety = Readonly<{
  noLiveSms: true;
...
export type Sms242CFinalRunCommandAcceptanceGateReport = Readonly<{
  ...
  readiness: Sms242CReadiness;
  safety: Sms242CSafety;
}>;
