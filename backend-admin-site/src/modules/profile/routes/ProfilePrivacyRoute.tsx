...
import { SABI_ACCOUNT_DELETION_PRIVACY_ROW } from "../data/privacy";
...
export default function PrivacyScreen() {
  ...
  const privacySecurityRowsForPlay = useMemo(() => {
    const alreadyHasAccountDeletion = privacySecurityRows.some(
      (row) => row.key === SABI_ACCOUNT_DELETION_PRIVACY_ROW.key,
    );

    return alreadyHasAccountDeletion
      ? privacySecurityRows
      : [...privacySecurityRows, SABI_ACCOUNT_DELETION_PRIVACY_ROW];
  }, [privacySecurityRows]);
        ...
        <View style={styles.container}>
          ...
          >
            ...
            <Section
              ...
              rows={privacySecurityRowsForPlay}
