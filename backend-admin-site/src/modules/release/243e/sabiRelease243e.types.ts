export type SabiRelease243EReadiness = Readonly<{
...
export type SabiRelease243ESafety = Readonly<{
...
export type SabiRelease243EApprovalGate = Readonly<{
  ...
  emailDnsAuthenticationOwnerApprovalRequired: Readonly<{ mx: true; spf: true; dkim: true; dmarc: true }>;
  ...
  executableNow: false;
  noExecutionNow: true;
  readiness: SabiRelease243EReadiness;
  safety: SabiRelease243ESafety;
