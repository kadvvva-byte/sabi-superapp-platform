export type SabiRelease244YSafety = Readonly<Record<string, boolean>>;

export type SabiRelease244YReadiness = Readonly<Record<string, number>>;

export type SabiRelease244YReport = Readonly<{
  version: string;
  marker: string;
  status: 'passed';
  ...
  nextStep: string;
  readiness: SabiRelease244YReadiness;
  safety: SabiRelease244YSafety;
