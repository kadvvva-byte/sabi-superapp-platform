export type SabiRelease245FSafety = Readonly<Record<string, boolean>>;

export type SabiRelease245FReadiness = Readonly<Record<string, number>>;

export type SabiRelease245FReport = Readonly<{
  version: string;
  marker: string;
  status: 'passed';
  ...
  nextStep: string;
  readiness: SabiRelease245FReadiness;
  safety: SabiRelease245FSafety;
