import type { SabiRelease246LReport } from './sabiRelease246L.types';

export const sabiRelease246LReport: SabiRelease246LReport = {
  "version": "SABI-RELEASE-246L-SMS-REGION-POLICY-NO-LIVE-SMS-RUNTIME-READINESS",
  "status": "passed",
  "createdAt": "2026-06-23T05:29:59.496Z",
  "approval": "I approve RELEASE-246L configure Firebase Auth SMS region policy for project sabi-official-prod-37629 and verify no-live-SMS runtime readiness only, no live SMS, no Firebase user creation, no phone auth live test, no DNS mutation, no Google Pay Billing, no wallet, no payment, no payout",
  "firebaseProjectId": "sabi-official-prod-37629",
  "officialSiteProjectId": "sabi-official-prod",
  "scope": "configure_sms_region_allowlist_verify_no_live_sms_runtime_readiness",
  "approvedSmsRegionPolicy": {
    ...
    "rationale": {
      "GB": "United Kingdom official company base",
      "UZ": "Uzbekistan current owner operating base"
    }
  },
  "beforeSummary": {
  ...
  "readiness": {
    ...
    "smsRegionPolicyUpdateReadiness": 100,
    "smsRegionPolicyLockedReadiness": 100,
  ...
  "safety": {
    ...
    "smsRegionPolicyMutationApproved": true,
    "allowlistOnlyPolicy": true,
  ...
  "checks": [
    {
      "name": "246l_firebase_project_visible",
      "passed": true,
      "details": {
        "firebaseProjectId": "sabi-official-prod-37629"
      }
    ...
    {
      "name": "246l_identitytoolkit_api_enabled",
      "passed": true,
      "details": {
    ...
    {
      "name": "246l_access_token_obtained_without_printing_value",
      "passed": true,
      "details": {
        "ok": true,
        "status": 0,
    ...
    {
      "name": "246l_auth_config_readable_after",
      "passed": true,
      "details": {
        "name": "projects/970072647981/config",
        "phoneNumberEnabled": true,
    ...
    {
      "name": "246l_phone_provider_still_enabled",
      "passed": true,
      "details": {
        "name": "projects/970072647981/config",
        "phoneNumberEnabled": true,
    ...
    {
      "name": "246l_sms_region_policy_update_ok_or_already_locked",
      "passed": true,
      "details": {
        "primaryUpdateOk": true,
        "fallbackUpdateOk": false,
        "approvedAllowedRegions": [
          "GB",
          "UZ"
        ],
        "afterAllowedRegions": [
    ...
    {
      "name": "246l_sms_region_policy_allowlist_only_locked",
      "passed": true,
      "details": {
        "mode": "allowlistOnly",
        "approvedAllowedRegions": [
    ...
    {
      "name": "246l_mobile_firebase_configs_ready",
      "passed": true,
      "details": {
        "mobileRootExists": true,
        "appJson": {
    ...
    {
      "name": "246l_no_live_sms_runtime_readiness",
      "passed": true,
      "details": {
        "checksOnly": true,
        "signInWithPhoneNumberExecuted": false,
    ...
    {
      "name": "246l_official_site_still_live",
      "passed": true,
      "details": {
        "name": "live_https_root_readonly",
        "command": "$u=\"https://sabiai.app/\"; try { $r=Invoke-WebRequest -Uri $u -UseBasicParsing -TimeoutSec 90; Write-Output (\"STATUS=\" + $r.StatusCode); if ($r.StatusCode -ge 200 -and $r.StatusCode -lt 400) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "246l_no_api_key_or_secret_value_printed_in_report",
      "passed": true,
      "details": {}
    },
    {
      "name": "246l_no_live_sms_sent_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "246l_no_firebase_user_creation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "246l_no_phone_auth_live_test_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "246l_no_dns_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "246l_no_google_pay_billing_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "246l_no_wallet_payment_payout_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "246l_no_db_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "246l_no_secret_manager_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "246l_no_env_read_write_now",
      "passed": true,
      "details": {}
    }
  ],
  ...
  "warnings": [
    ...
    "first_live_sms_requires_separate_exact_owner_approval_and_real_test_number"
  ],
  "nextStep": "246M_first_live_sms_test_requires_exact_owner_approval_real_test_phone_number_and_cost_acceptance",
  "exactApprovalForNext": "I approve RELEASE-246M first live Firebase Phone Auth SMS test in project sabi-official-prod-37629 to my provided test phone number only, I accept Firebase SMS charges, no Firebase user deletion, no DNS mutation, no Google Pay Billing, no wallet, no payment, no payout",
  "artifacts": {}
} as unknown as SabiRelease246LReport;
