import type { SabiRelease249AFix3RetryReport } from './sabiRelease249AFix3Retry.types';

export const sabiRelease249AFix3RetryReport: SabiRelease249AFix3RetryReport = {
  "version": "SABI-RELEASE-249A-FIX3-RETRY-EMAIL-DNS-SECURITY-READONLY",
  "status": "failed",
  "createdAt": "2026-06-23T09:16:24.191Z",
  "approval": "I approve RELEASE-249A-FIX3-RETRY read-only email DNS security recheck after SPF/DMARC propagation for sabiai.app, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "officialDomain": "sabiai.app",
  "officialSiteProjectId": "sabi-official-prod",
  "firebaseProjectId": "sabi-official-prod-37629",
  "scope": "read_only_retry_email_dns_security_recheck_after_spf_dmarc_propagation_no_mutation",
  "expectedRecords": {
  ...
  "previousFix3": {
    "path": ".data/release/249a-fix3/249a-fix3-report.json",
    "status": "failed"
  },
  "observations": {
    "rootTxtChecks": {
      ...
      "quad9_9_9_9_9": {
        "name": "root_txt_quad9_9_9_9_9_readonly",
    ...
    "dmarcChecks": {
      ...
      "quad9_9_9_9_9": {
        "name": "dmarc_txt_quad9_9_9_9_9_readonly",
    ...
    "mxChecks": {
      ...
      "quad9_9_9_9_9": {
        "name": "mx_quad9_9_9_9_9_readonly",
    ...
    "dkimChecks": {
      ...
      "quad9_9_9_9_9": {
        "name": "google_dkim_quad9_9_9_9_9_readonly",
    ...
    "wrongSpfHostCheck": {
      "name": "wrong_spf_host_sabiai_app_sabiai_app_readonly",
    ...
    "wrongDmarcHostCheck": {
      "name": "wrong_dmarc_host_double_domain_readonly",
  ...
  "derived": {
    ...
    "wrongHostDiagnostics": {
      "wrongSpfHostTxtRecords": [],
      "wrongDmarcHostTxtRecords": [],
      "wrongSpfHostHasExpected": false,
      "wrongDmarcHostHasExpected": false
    },
  ...
  "readiness": {
    ...
    "previousFix3FailedExpectedReadiness": 100,
    ...
    "wrongDoubleDomainDiagnosticsReadiness": 100,
    "release249AFix3RetryReadiness": 0,
    "dnsMutationNow": 0,
  ...
  "checks": [
    {
      "name": "249a_fix3_retry_previous_fix2_ready",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix3_retry_previous_fix3_failed_expected",
      "passed": true,
      "details": {
        "previousFix3Path": ".data/release/249a-fix3/249a-fix3-report.json",
        "status": "failed"
      }
    },
    {
      "name": "249a_fix3_retry_official_site_live_readonly",
      "passed": true,
      "details": {
        "name": "official_site_readonly",
        "command": "$u=\"https://sabiai.app/\"; try { $r=Invoke-WebRequest -Uri $u -UseBasicParsing -TimeoutSec 90; Write-Output (\"STATUS=\" + $r.StatusCode); if ($r.StatusCode -ge 200 -and $r.StatusCode -lt 400) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix3_retry_gcloud_full_path_ready_readonly",
      "passed": true,
      "details": {
        "gcloudVersion": {
          "name": "gcloud_full_path_version_readonly",
    ...
    {
      "name": "249a_fix3_retry_spf_google_ready_all_resolvers",
      "passed": false,
      "details": {
        "system": {
          "spfRecords": [],
    ...
    {
      "name": "249a_fix3_retry_spf_single_record_all_resolvers",
      "passed": false,
      "details": {
        "system": {
          "spfRecords": [],
    ...
    {
      "name": "249a_fix3_retry_dmarc_ready_all_resolvers",
      "passed": false,
      "details": {
        "system": {
          "spfRecords": [],
    ...
    {
      "name": "249a_fix3_retry_mx_google_ready_all_resolvers",
      "passed": true,
      "details": {
        "system": {
          "spfRecords": [],
    ...
    {
      "name": "249a_fix3_retry_dkim_ready_all_resolvers",
      "passed": true,
      "details": {
        "system": {
          "spfRecords": [],
    ...
    {
      "name": "249a_fix3_retry_smtp_google_network_reachable",
      "passed": true,
      "details": {
        "name": "smtp_google_587_tcp_readonly",
        "command": "try { $t = Test-NetConnection smtp.gmail.com -Port 587 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix3_retry_imap_google_network_reachable",
      "passed": true,
      "details": {
        "name": "imap_google_993_tcp_readonly",
        "command": "try { $t = Test-NetConnection imap.gmail.com -Port 993 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix3_retry_email_dns_security_ready",
      "passed": false,
      "details": {
        "system": {
          "spfRecords": [],
    ...
    {
      "name": "249a_fix3_retry_email_infrastructure_ready_no_live_send",
      "passed": false,
      "details": {
        "emailDnsSecurityReady": false,
        "smtpReachable": true,
    ...
    {
      "name": "249a_fix3_retry_wrong_double_domain_diagnostics_done",
      "passed": true,
      "details": {
        "wrongHostDiagnostics": {
          "wrongSpfHostTxtRecords": [],
    ...
    {
      "name": "249a_fix3_retry_no_dns_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix3_retry_no_cloud_run_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix3_retry_no_firebase_user_deletion_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix3_retry_no_google_pay_billing_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix3_retry_no_wallet_payment_payout_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix3_retry_no_db_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix3_retry_no_secret_manager_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix3_retry_no_env_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix3_retry_no_live_email_sent_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix3_retry_no_mailbox_mutation_now",
      "passed": true,
      "details": {}
    }
  ],
  "blockers": [
    "249a_fix3_retry_spf_google_ready_all_resolvers",
    "249a_fix3_retry_spf_single_record_all_resolvers",
    "249a_fix3_retry_dmarc_ready_all_resolvers",
    "249a_fix3_retry_email_dns_security_ready",
    "249a_fix3_retry_email_infrastructure_ready_no_live_send"
  ],
  "warnings": [
    "spf_dmarc_still_not_visible_if_waited_long_enough_check_dns_provider_host_names_zone_and_save_changes",
    "249a_fix3_retry_does_not_send_live_email",
  ...
  "nextStep": "249A_FIX3_RETRY_OR_DNS_PROVIDER_CORRECTION_REQUIRED",
  "exactApprovalForNext": "I confirm I checked/corrected SPF and DMARC host/name in the real DNS provider for sabiai.app and approve RELEASE-249A-FIX3-RETRY2 read-only email DNS security recheck only, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "artifacts": {}
} as unknown as SabiRelease249AFix3RetryReport;
