import type { SabiRelease249AFix4RecheckReport } from './sabiRelease249AFix4Recheck.types';

export const sabiRelease249AFix4RecheckReport: SabiRelease249AFix4RecheckReport = {
  "version": "SABI-RELEASE-249A-FIX4-RECHECK-EMAIL-DNS-SECURITY-READONLY",
  "status": "failed",
  "createdAt": "2026-06-23T09:37:10.341Z",
  "approval": "I confirm I corrected SPF and DMARC in the active authoritative DNS provider for sabiai.app based on 249A-FIX4 diagnosis and approve RELEASE-249A-FIX4-RECHECK read-only email DNS security recheck only, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "officialDomain": "sabiai.app",
  "officialSiteProjectId": "sabi-official-prod",
  "firebaseProjectId": "sabi-official-prod-37629",
  "scope": "read_only_authoritative_and_public_email_dns_security_recheck_no_mutation",
  "expectedRecords": {
  ...
  "derived": {
    ...
    "diagnosis": "spf_dmarc_still_absent_at_authoritative_dns_provider_or_not_saved"
  },
  "readiness": {
    ...
    "release249AFix4RecheckReadiness": 0,
    "dnsMutationNow": 0,
  ...
  "checks": [
    {
      "name": "249a_fix4_recheck_previous_fix4_ready",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck_authoritative_ns_expected",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck_soa_checked",
      "passed": true,
      "details": {
        "soaByResolver": {
          "system": {
    ...
    {
      "name": "249a_fix4_recheck_authoritative_spf_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck_authoritative_dmarc_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck_authoritative_mx_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck_authoritative_dkim_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck_public_spf_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck_public_dmarc_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck_public_mx_ready",
      "passed": true,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck_public_dkim_ready",
      "passed": true,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck_authoritative_dns_security_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck_public_dns_security_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck_official_site_live_readonly",
      "passed": true,
      "details": {
        "name": "official_site_readonly",
        "command": "$u=\"https://sabiai.app/\"; try { $r=Invoke-WebRequest -Uri $u -UseBasicParsing -TimeoutSec 90; Write-Output (\"STATUS=\" + $r.StatusCode); if ($r.StatusCode -ge 200 -and $r.StatusCode -lt 400) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck_gcloud_ready_readonly",
      "passed": true,
      "details": {
        "gcloudVersion": {
          "name": "gcloud_full_path_version_readonly",
    ...
    {
      "name": "249a_fix4_recheck_smtp_network_ready_readonly",
      "passed": true,
      "details": {
        "name": "smtp_google_587_tcp_readonly",
        "command": "try { $t = Test-NetConnection smtp.gmail.com -Port 587 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck_imap_network_ready_readonly",
      "passed": true,
      "details": {
        "name": "imap_google_993_tcp_readonly",
        "command": "try { $t = Test-NetConnection imap.gmail.com -Port 993 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck_email_infrastructure_ready_no_live_send",
      "passed": false,
      "details": {
        "publicEmailDnsSecurityReady": false,
        "officialSiteLive": true,
    ...
    {
      "name": "249a_fix4_recheck_no_dns_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck_no_cloud_run_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck_no_firebase_user_deletion_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck_no_google_pay_billing_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck_no_wallet_payment_payout_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck_no_db_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck_no_secret_manager_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck_no_env_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck_no_live_email_sent_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck_no_mailbox_mutation_now",
      "passed": true,
      "details": {}
    }
  ],
  "blockers": [
    "249a_fix4_recheck_authoritative_spf_ready",
    "249a_fix4_recheck_authoritative_dmarc_ready",
    "249a_fix4_recheck_public_spf_ready",
    "249a_fix4_recheck_public_dmarc_ready",
    "249a_fix4_recheck_authoritative_dns_security_ready",
    "249a_fix4_recheck_public_dns_security_ready",
    "249a_fix4_recheck_email_infrastructure_ready_no_live_send"
  ],
  "warnings": [
    "spf_dmarc_still_not_ready_at_authoritative_dns_check_namecheap_host_records_saved",
    "249a_fix4_recheck_does_not_send_live_email",
  ...
  "nextStep": "249A_FIX4_RECHECK_OR_NAMECHEAP_HOST_RECORDS_CORRECTION_REQUIRED",
  "exactApprovalForNext": "I confirm I rechecked/corrected Namecheap Host Records for SPF and DMARC for sabiai.app and approve RELEASE-249A-FIX4-RECHECK2 read-only email DNS security recheck only, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "artifacts": {}
} as unknown as SabiRelease249AFix4RecheckReport;
