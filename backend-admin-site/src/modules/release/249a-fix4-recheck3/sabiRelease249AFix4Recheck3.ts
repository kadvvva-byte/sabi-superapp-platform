import type { SabiRelease249AFix4Recheck3Report } from './sabiRelease249AFix4Recheck3.types';

export const sabiRelease249AFix4Recheck3Report: SabiRelease249AFix4Recheck3Report = {
  "version": "SABI-RELEASE-249A-FIX4-RECHECK3-EMAIL-DNS-SECURITY-READONLY",
  "status": "failed",
  "createdAt": "2026-06-23T09:59:29.689Z",
  "approval": "I confirm I corrected Namecheap TXT Host Records again and clicked Save for SPF and DMARC for sabiai.app and approve RELEASE-249A-FIX4-RECHECK3 read-only email DNS security recheck only, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "officialDomain": "sabiai.app",
  "officialSiteProjectId": "sabi-official-prod",
  "firebaseProjectId": "sabi-official-prod-37629",
  "scope": "read_only_authoritative_and_public_email_dns_security_recheck3_no_mutation",
  "expectedRecords": {
  ...
  "derived": {
    ...
    "diagnosis": "spf_dmarc_still_absent_at_authoritative_namecheap_zone_after_save_check_records_visibility_in_namecheap_panel",
    "nextAction": "Open Namecheap Domain List > Manage sabiai.app > Advanced DNS. In Host Records add TXT Record rows only. Host @ with SPF value. Host _dmarc with DMARC value. Click green checkmark/save on each row. Confirm the rows remain visible after page refresh."
  },
  "readiness": {
    ...
    "release249AFix4Recheck3Readiness": 0,
    "dnsMutationNow": 0,
  ...
  "checks": [
    {
      "name": "249a_fix4_recheck3_previous_fix4_ready",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck3_previous_recheck_failed_expected",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck3_previous_recheck2_failed_expected",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck3_authoritative_ns_expected",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck3_soa_checked",
      "passed": true,
      "details": {
        "soaByResolver": {
          "system": {
    ...
    {
      "name": "249a_fix4_recheck3_authoritative_spf_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck3_authoritative_dmarc_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck3_authoritative_mx_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck3_authoritative_dkim_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck3_public_spf_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck3_public_dmarc_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck3_public_mx_ready",
      "passed": true,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck3_public_dkim_ready",
      "passed": true,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck3_authoritative_dns_security_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck3_public_dns_security_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck3_official_site_live_readonly",
      "passed": true,
      "details": {
        "name": "official_site_readonly",
        "command": "$u=\"https://sabiai.app/\"; try { $r=Invoke-WebRequest -Uri $u -UseBasicParsing -TimeoutSec 90; Write-Output (\"STATUS=\" + $r.StatusCode); if ($r.StatusCode -ge 200 -and $r.StatusCode -lt 400) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck3_gcloud_ready_readonly",
      "passed": true,
      "details": {
        "gcloudVersion": {
          "name": "gcloud_full_path_version_readonly",
    ...
    {
      "name": "249a_fix4_recheck3_smtp_network_ready_readonly",
      "passed": true,
      "details": {
        "name": "smtp_google_587_tcp_readonly",
        "command": "try { $t = Test-NetConnection smtp.gmail.com -Port 587 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck3_imap_network_ready_readonly",
      "passed": true,
      "details": {
        "name": "imap_google_993_tcp_readonly",
        "command": "try { $t = Test-NetConnection imap.gmail.com -Port 993 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck3_email_infrastructure_ready_no_live_send",
      "passed": false,
      "details": {
        "publicEmailDnsSecurityReady": false,
        "officialSiteLive": true,
    ...
    {
      "name": "249a_fix4_recheck3_diagnostics_done",
      "passed": true,
      "details": {
        "diagnosticParsed": {
          "spfDoubleDomainRecords": [],
    ...
    {
      "name": "249a_fix4_recheck3_no_dns_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck3_no_cloud_run_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck3_no_firebase_user_deletion_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck3_no_google_pay_billing_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck3_no_wallet_payment_payout_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck3_no_db_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck3_no_secret_manager_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck3_no_env_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck3_no_live_email_sent_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck3_no_mailbox_mutation_now",
      "passed": true,
      "details": {}
    }
  ],
  "blockers": [
    "249a_fix4_recheck3_authoritative_spf_ready",
    "249a_fix4_recheck3_authoritative_dmarc_ready",
    "249a_fix4_recheck3_public_spf_ready",
    "249a_fix4_recheck3_public_dmarc_ready",
    "249a_fix4_recheck3_authoritative_dns_security_ready",
    "249a_fix4_recheck3_public_dns_security_ready",
    "249a_fix4_recheck3_email_infrastructure_ready_no_live_send"
  ],
  "warnings": [
    "spf_dmarc_still_not_ready_at_authoritative_dns_namecheap_rows_not_visible_to_nameservers_yet_or_not_saved",
    "249a_fix4_recheck3_does_not_send_live_email",
  ...
  "nextStep": "249A_FIX4_RECHECK4_OR_NAMECHEAP_PANEL_SCREENSHOT_REVIEW_REQUIRED",
  "exactApprovalForNext": "I confirm I corrected/verified Namecheap TXT Host Records are visible in the panel for SPF and DMARC for sabiai.app and approve RELEASE-249A-FIX4-RECHECK4 read-only email DNS security recheck only, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "artifacts": {}
} as unknown as SabiRelease249AFix4Recheck3Report;
