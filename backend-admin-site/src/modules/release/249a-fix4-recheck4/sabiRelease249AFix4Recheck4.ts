import type { SabiRelease249AFix4Recheck4Report } from './sabiRelease249AFix4Recheck4.types';

export const sabiRelease249AFix4Recheck4Report: SabiRelease249AFix4Recheck4Report = {
  "version": "SABI-RELEASE-249A-FIX4-RECHECK4-EMAIL-DNS-SECURITY-READONLY",
  "status": "failed",
  "createdAt": "2026-06-23T10:08:20.877Z",
  "approval": "I confirm I corrected/verified Namecheap TXT Host Records are visible in the panel for SPF and DMARC for sabiai.app and approve RELEASE-249A-FIX4-RECHECK4 read-only email DNS security recheck only, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "officialDomain": "sabiai.app",
  "officialSiteProjectId": "sabi-official-prod",
  "firebaseProjectId": "sabi-official-prod-37629",
  "scope": "read_only_authoritative_and_public_email_dns_security_recheck4_no_mutation",
  "expectedRecords": {
  ...
  "previousRecheck2": {
    "path": ".data/release/249a-fix4-recheck2/249a-fix4-recheck2-report.json",
    "status": "failed"
  },
  "previousRecheck3": {
    "path": ".data/release/249a-fix4-recheck3/249a-fix4-recheck3-report.json",
    "status": "failed"
  },
  "observations": {
    "nsChecks": {
    ...
    "diagnosticChecks": {
      ...
      "dmarcAtRootWrongHost": {
        "name": "diagnostic_dmarc_at_root_wrong_host_readonly",
        "command": "try { Resolve-DnsName sabiai.app -Type TXT -Server 8.8.8.8 | Select-Object -Property Strings | ConvertTo-Json -Compress; exit 0 } catch { Write-Output $_.Exception.Message; exit 0 }",
        "status": 0,
        "stdout": "{\"Strings\":[\"google-site-verification=OLR8Uj0o5mrDjW4lgHT7LeKXcMFyTrKxea8KvTXVO4U\"]}",
        "stderr": "",
      ...
      "spfAtWwwWrongHost": {
        "name": "diagnostic_spf_at_www_wrong_host_readonly",
  ...
  "derived": {
    ...
    "soaSerialChangedSinceRecheck3": false,
    "authoritativeNs": [
      "pdns1.registrar-servers.com",
      "pdns2.registrar-servers.com"
    ],
    ...
    "diagnosticParsed": {
      "spfDoubleDomainRecords": [],
      "dmarcDoubleDomainRecords": [],
      "dmarcAtRootWrongHostRecords": [
        "google-site-verification=OLR8Uj0o5mrDjW4lgHT7LeKXcMFyTrKxea8KvTXVO4U"
      ],
      "spfAtWwwWrongHostRecords": []
    },
    ...
    "diagnosis": "spf_dmarc_still_absent_and_soa_serial_unchanged_namecheap_changes_not_published_to_zone",
    "nextAction": "Because the Namecheap panel reportedly shows the TXT rows but the authoritative SOA serial may not have changed and authoritative NS still do not show SPF/DMARC, capture a screenshot of Namecheap Advanced DNS Host Records and verify the domain uses Namecheap BasicDNS/custom registrar-servers nameservers, not a separate DNS profile."
  },
  "readiness": {
    "previousFix4Readiness": 100,
    "previousRecheckFailedExpectedReadiness": 100,
    "previousRecheck2FailedExpectedReadiness": 100,
    "previousRecheck3FailedExpectedReadiness": 100,
    ...
    "diagnosticsReadiness": 100,
    "release249AFix4Recheck4Readiness": 0,
    "dnsMutationNow": 0,
  ...
  "checks": [
    {
      "name": "249a_fix4_recheck4_previous_fix4_ready",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck4_previous_recheck_failed_expected",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck4_previous_recheck2_failed_expected",
      "passed": true,
      "details": {
        "previousRecheck2Path": ".data/release/249a-fix4-recheck2/249a-fix4-recheck2-report.json",
        "status": "failed"
      }
    },
    {
      "name": "249a_fix4_recheck4_previous_recheck3_failed_expected",
      "passed": true,
      "details": {
        "previousRecheck3Path": ".data/release/249a-fix4-recheck3/249a-fix4-recheck3-report.json",
        "status": "failed"
      }
    },
    {
      "name": "249a_fix4_recheck4_authoritative_ns_expected",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck4_soa_checked",
      "passed": true,
      "details": {
        "previousSoaSerial": 1782176585,
        "currentSoaSerial": 1782176585,
    ...
    {
      "name": "249a_fix4_recheck4_authoritative_spf_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck4_authoritative_dmarc_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck4_authoritative_mx_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck4_authoritative_dkim_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck4_public_spf_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck4_public_dmarc_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck4_public_mx_ready",
      "passed": true,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck4_public_dkim_ready",
      "passed": true,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck4_authoritative_dns_security_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck4_public_dns_security_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck4_official_site_live_readonly",
      "passed": true,
      "details": {
        "name": "official_site_readonly",
        "command": "$u=\"https://sabiai.app/\"; try { $r=Invoke-WebRequest -Uri $u -UseBasicParsing -TimeoutSec 90; Write-Output (\"STATUS=\" + $r.StatusCode); if ($r.StatusCode -ge 200 -and $r.StatusCode -lt 400) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck4_gcloud_ready_readonly",
      "passed": true,
      "details": {
        "gcloudVersion": {
          "name": "gcloud_full_path_version_readonly",
    ...
    {
      "name": "249a_fix4_recheck4_smtp_network_ready_readonly",
      "passed": true,
      "details": {
        "name": "smtp_google_587_tcp_readonly",
        "command": "try { $t = Test-NetConnection smtp.gmail.com -Port 587 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck4_imap_network_ready_readonly",
      "passed": true,
      "details": {
        "name": "imap_google_993_tcp_readonly",
        "command": "try { $t = Test-NetConnection imap.gmail.com -Port 993 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck4_email_infrastructure_ready_no_live_send",
      "passed": false,
      "details": {
        "publicEmailDnsSecurityReady": false,
        "officialSiteLive": true,
    ...
    {
      "name": "249a_fix4_recheck4_diagnostics_done",
      "passed": true,
      "details": {
        "diagnosticParsed": {
          "spfDoubleDomainRecords": [],
    ...
    {
      "name": "249a_fix4_recheck4_no_dns_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck4_no_cloud_run_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck4_no_firebase_user_deletion_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck4_no_google_pay_billing_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck4_no_wallet_payment_payout_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck4_no_db_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck4_no_secret_manager_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck4_no_env_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck4_no_live_email_sent_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck4_no_mailbox_mutation_now",
      "passed": true,
      "details": {}
    }
  ],
  "blockers": [
    "249a_fix4_recheck4_authoritative_spf_ready",
    "249a_fix4_recheck4_authoritative_dmarc_ready",
    "249a_fix4_recheck4_public_spf_ready",
    "249a_fix4_recheck4_public_dmarc_ready",
    "249a_fix4_recheck4_authoritative_dns_security_ready",
    "249a_fix4_recheck4_public_dns_security_ready",
    "249a_fix4_recheck4_email_infrastructure_ready_no_live_send"
  ],
  "warnings": [
    "spf_dmarc_still_not_ready_at_authoritative_dns_namecheap_panel_or_nameserver_profile_mismatch_possible",
    "soa_serial_unchanged_since_previous_recheck_namecheap_changes_may_not_have_published",
    "249a_fix4_recheck4_does_not_send_live_email",
  ...
  "nextStep": "249A_FIX4_SCREENSHOT_REVIEW_OR_NAMECHEAP_SUPPORT_CHECK_REQUIRED",
  "exactApprovalForNext": "I will send a screenshot of Namecheap Advanced DNS Host Records for sabiai.app showing SPF and DMARC rows so you can review the exact DNS panel state",
  "artifacts": {}
} as unknown as SabiRelease249AFix4Recheck4Report;
