import type { SabiRelease249AFix4Recheck6Report } from './sabiRelease249AFix4Recheck6.types';

export const sabiRelease249AFix4Recheck6Report: SabiRelease249AFix4Recheck6Report = {
  "version": "SABI-RELEASE-249A-FIX4-RECHECK6-EMAIL-DNS-SECURITY-READONLY",
  "status": "failed",
  "createdAt": "2026-06-23T10:27:10.268Z",
  "approval": "I approve RELEASE-249A-FIX4-RECHECK6 read-only email DNS security recheck after waiting for Namecheap DNS propagation for sabiai.app, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "officialDomain": "sabiai.app",
  "officialSiteProjectId": "sabi-official-prod",
  "firebaseProjectId": "sabi-official-prod-37629",
  "scope": "read_only_authoritative_and_public_email_dns_security_recheck6_no_mutation",
  "expectedRecords": {
  ...
  "previousRecheck5": {
    "path": ".data/release/249a-fix4-recheck5/249a-fix4-recheck5-report.json",
    "status": "failed"
  },
  "observations": {
    "nsChecks": {
  ...
  "derived": {
    ...
    "soaSerialChangedSinceRecheck5": false,
    "authoritativeNs": [
      "pdns1.registrar-servers.com",
      "pdns2.registrar-servers.com"
    ],
  ...
  "readiness": {
    "previousRecheck5FailedExpectedReadiness": 100,
    "authoritativeNsReadiness": 100,
    "authoritativeSoaReadiness": 100,
    "soaSerialChangedSinceRecheck5Readiness": 0,
    ...
    "release249AFix4Recheck6Readiness": 0,
    "dnsMutationNow": 0,
  ...
  "checks": [
    {
      "name": "249a_fix4_recheck6_previous_recheck5_failed_expected",
      "passed": true,
      "details": {
        "previousRecheck5Path": ".data/release/249a-fix4-recheck5/249a-fix4-recheck5-report.json"
      }
    },
    {
      "name": "249a_fix4_recheck6_authoritative_ns_expected",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck6_soa_checked",
      "passed": true,
      "details": {
        "previousSoaSerial": 1782176585,
        "currentSoaSerial": 1782176585,
    ...
    {
      "name": "249a_fix4_recheck6_authoritative_spf_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck6_authoritative_dmarc_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck6_authoritative_mx_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck6_authoritative_dkim_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck6_public_spf_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck6_public_dmarc_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck6_public_mx_ready",
      "passed": true,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck6_public_dkim_ready",
      "passed": true,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck6_authoritative_dns_security_ready",
      "passed": false,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck6_public_dns_security_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck6_official_site_live_readonly",
      "passed": true,
      "details": {
        "name": "official_site_readonly",
        "command": "$u=\"https://sabiai.app/\"; try { $r=Invoke-WebRequest -Uri $u -UseBasicParsing -TimeoutSec 90; Write-Output (\"STATUS=\" + $r.StatusCode); if ($r.StatusCode -ge 200 -and $r.StatusCode -lt 400) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck6_gcloud_ready_readonly",
      "passed": true,
      "details": {
        "gcloudVersion": {
          "name": "gcloud_full_path_version_readonly",
    ...
    {
      "name": "249a_fix4_recheck6_smtp_network_ready_readonly",
      "passed": true,
      "details": {
        "name": "smtp_google_587_tcp_readonly",
        "command": "try { $t = Test-NetConnection smtp.gmail.com -Port 587 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck6_imap_network_ready_readonly",
      "passed": true,
      "details": {
        "name": "imap_google_993_tcp_readonly",
        "command": "try { $t = Test-NetConnection imap.gmail.com -Port 993 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck6_email_infrastructure_ready_no_live_send",
      "passed": false,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck6_no_dns_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck6_no_cloud_run_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck6_no_firebase_user_deletion_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck6_no_google_pay_billing_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck6_no_wallet_payment_payout_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck6_no_db_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck6_no_secret_manager_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck6_no_env_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck6_no_live_email_sent_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck6_no_mailbox_mutation_now",
      "passed": true,
      "details": {}
    }
  ],
  "blockers": [
    "249a_fix4_recheck6_authoritative_spf_ready",
    "249a_fix4_recheck6_authoritative_dmarc_ready",
    "249a_fix4_recheck6_public_spf_ready",
    "249a_fix4_recheck6_public_dmarc_ready",
    "249a_fix4_recheck6_authoritative_dns_security_ready",
    "249a_fix4_recheck6_public_dns_security_ready",
    "249a_fix4_recheck6_email_infrastructure_ready_no_live_send"
  ],
  "warnings": [
    "spf_dmarc_not_yet_authoritative_after_waiting_namecheap_support_may_be_required",
    "249a_fix4_recheck6_does_not_send_live_email",
  ...
  "nextStep": "249A_NAMECHEAP_SUPPORT_OR_RECHECK_AFTER_LONGER_PROPAGATION",
  "exactApprovalForNext": "I approve RELEASE-249A-FIX4-RECHECK7 read-only email DNS security recheck after longer Namecheap propagation for sabiai.app, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "artifacts": {}
} as unknown as SabiRelease249AFix4Recheck6Report;
