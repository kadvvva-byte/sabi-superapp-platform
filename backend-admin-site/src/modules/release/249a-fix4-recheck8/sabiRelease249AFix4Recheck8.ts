import type { SabiRelease249AFix4Recheck8Report } from './sabiRelease249AFix4Recheck8.types';

export const sabiRelease249AFix4Recheck8Report: SabiRelease249AFix4Recheck8Report = {
  "version": "SABI-RELEASE-249A-FIX4-RECHECK8-EMAIL-DNS-SECURITY-READONLY",
  "status": "failed",
  "createdAt": "2026-06-23T10:53:35.303Z",
  "approval": "I confirm SPF and DMARC TXT records are saved and visible in Namecheap Host Records for sabiai.app after refresh, with DMARC host exactly _dmarc, and approve RELEASE-249A-FIX4-RECHECK8 read-only email DNS security recheck only, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "officialDomain": "sabiai.app",
  "officialSiteProjectId": "sabi-official-prod",
  "firebaseProjectId": "sabi-official-prod-37629",
  "scope": "read_only_authoritative_and_public_email_dns_security_recheck8_no_mutation",
  "expectedRecords": {
    "spf": "v=spf1 include:_spf.google.com ~all",
    "dmarc": "v=DMARC1; p=none; rua=mailto:dmarc@sabiai.app; pct=100; adkim=s; aspf=s"
  },
  "previousRecheck7": {
    "path": ".data/release/249a-fix4-recheck7/249a-fix4-recheck7-report.json",
    "status": "failed"
  },
  "observations": {
    "nsChecks": {
    ...
    "publicChecks": {
      ...
      "google_8_8_8_8": {
        "rootTxt": {
          ...
          "status": 0,
          "stdout": "[{\"Strings\":[\"google-site-verification=OLR8Uj0o5mrDjW4lgHT7LeKXcMFyTrKxea8KvTXVO4U\"]},{\"Strings\":[\"v=spf1 include:_spf.google.com ~all\"]}]",
          "stderr": "",
          "ok": true
        },
        "dmarcTxt": {
  ...
  "derived": {
    ...
    "soaSerialChangedSinceRecheck7": false,
    "authoritativeNs": [
      "pdns1.registrar-servers.com",
      "pdns2.registrar-servers.com"
    ],
    ...
    "diagnosis": "authoritative_ready_public_resolvers_still_propagating"
  },
  "readiness": {
    "previousRecheck7FailedExpectedReadiness": 100,
    "authoritativeNsReadiness": 100,
    "authoritativeSoaReadiness": 100,
    "soaSerialChangedSinceRecheck7Readiness": 0,
    ...
    "release249AFix4Recheck8Readiness": 0,
    "dnsMutationNow": 0,
  ...
  "checks": [
    {
      "name": "249a_fix4_recheck8_previous_recheck7_failed_expected",
      "passed": true,
      "details": {
        "previousRecheck7Path": ".data/release/249a-fix4-recheck7/249a-fix4-recheck7-report.json"
      }
    },
    {
      "name": "249a_fix4_recheck8_authoritative_ns_expected",
      "passed": true,
      "details": {
    ...
    {
      "name": "249a_fix4_recheck8_soa_checked",
      "passed": true,
      "details": {
        "previousSoaSerial": 1782176585,
        "currentSoaSerial": 1782176585,
    ...
    {
      "name": "249a_fix4_recheck8_authoritative_spf_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck8_authoritative_dmarc_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck8_authoritative_mx_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck8_authoritative_dkim_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck8_public_spf_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck8_public_dmarc_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck8_public_mx_ready",
      "passed": true,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck8_public_dkim_ready",
      "passed": true,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck8_authoritative_dns_security_ready",
      "passed": true,
      "details": {
        "pdns1.registrar-servers.com": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck8_public_dns_security_ready",
      "passed": false,
      "details": {
        "system": {
          "rootTxtRecords": [
    ...
    {
      "name": "249a_fix4_recheck8_official_site_live_readonly",
      "passed": true,
      "details": {
        "name": "official_site_readonly",
        "command": "$u=\"https://sabiai.app/\"; try { $r=Invoke-WebRequest -Uri $u -UseBasicParsing -TimeoutSec 90; Write-Output (\"STATUS=\" + $r.StatusCode); if ($r.StatusCode -ge 200 -and $r.StatusCode -lt 400) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck8_gcloud_ready_readonly",
      "passed": true,
      "details": {
        "gcloudVersion": {
          "name": "gcloud_full_path_version_readonly",
    ...
    {
      "name": "249a_fix4_recheck8_smtp_network_ready_readonly",
      "passed": true,
      "details": {
        "name": "smtp_google_587_tcp_readonly",
        "command": "try { $t = Test-NetConnection smtp.gmail.com -Port 587 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck8_imap_network_ready_readonly",
      "passed": true,
      "details": {
        "name": "imap_google_993_tcp_readonly",
        "command": "try { $t = Test-NetConnection imap.gmail.com -Port 993 -WarningAction SilentlyContinue; Write-Output (\"TCP=\" + $t.TcpTestSucceeded); if ($t.TcpTestSucceeded) { exit 0 } else { exit 1 } } catch { Write-Output $_.Exception.Message; exit 1 }",
    ...
    {
      "name": "249a_fix4_recheck8_email_infrastructure_ready_no_live_send",
      "passed": false,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck8_wrong_host_diagnostics_done",
      "passed": true,
      "details": {
        "dmarcWithoutUnderscore": {
          "name": "diagnostic_dmarc_without_underscore_readonly",
    ...
    {
      "name": "249a_fix4_recheck8_no_dns_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck8_no_cloud_run_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck8_no_firebase_user_deletion_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck8_no_google_pay_billing_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck8_no_wallet_payment_payout_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck8_no_db_mutation_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck8_no_secret_manager_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck8_no_env_read_write_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck8_no_live_email_sent_now",
      "passed": true,
      "details": {}
    },
    {
      "name": "249a_fix4_recheck8_no_mailbox_mutation_now",
      "passed": true,
      "details": {}
    }
  ],
  "blockers": [
    "249a_fix4_recheck8_public_spf_ready",
    "249a_fix4_recheck8_public_dmarc_ready",
    "249a_fix4_recheck8_public_dns_security_ready",
    "249a_fix4_recheck8_email_infrastructure_ready_no_live_send"
  ],
  "warnings": [
    "authoritative_ready_but_public_resolvers_not_fully_propagated_wait_and_retry",
    "249a_fix4_recheck8_does_not_send_live_email",
  ...
  "nextStep": "249A_RECHECK9_AFTER_SHORT_PROPAGATION_OR_NAMECHEAP_PUBLISH_REVIEW",
  "exactApprovalForNext": "I approve RELEASE-249A-FIX4-RECHECK9 read-only email DNS security recheck after short Namecheap propagation for sabiai.app, no DNS mutation, no Cloud Run mutation, no Firebase user deletion, no Google Pay Billing, no wallet, no payment, no payout",
  "artifacts": {}
} as unknown as SabiRelease249AFix4Recheck8Report;
