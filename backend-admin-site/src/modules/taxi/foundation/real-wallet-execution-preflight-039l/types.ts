export type TaxiRealWalletExecutionPreflightSafety039L = Readonly<{
...
export type TaxiRealWalletExecutionPreflight039L = Readonly<{
  version: string;
  status: string;
  ...
  safety: TaxiRealWalletExecutionPreflightSafety039L;
  nextStep: string;
}>;

export type TaxiRealWalletExecutionPreflightReadiness039L = Readonly<{
  version: string;
  status: string;
